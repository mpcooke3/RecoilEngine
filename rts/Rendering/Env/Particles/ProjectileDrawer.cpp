...
#ifdef __APPLE__
	// See ProjFXFragProg.glsl — drop dark+opaque fragments so they don't
	// turn the destination into a solid black square under premultiplied
	// alpha blending. Visible symptom: commander beam-down `groundflash_scar`
	// and explosion scorches render correctly instead of as black squares.
